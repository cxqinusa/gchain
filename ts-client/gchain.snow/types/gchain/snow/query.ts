...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("gchain.snow.Query", "Params", data);
    return promise.then((data) => QueryParamsResponse.decode(new _m0.Reader(data)));
  }

  SystemInfo(request: QueryGetSystemInfoRequest): Promise<QueryGetSystemInfoResponse> {
    const data = QueryGetSystemInfoRequest.encode(request).finish();
    const promise = this.rpc.request("gchain.snow.Query", "SystemInfo", data);
  ...
  Game(request: QueryGetGameRequest): Promise<QueryGetGameResponse> {
    ...
    const promise = this.rpc.request("gchain.snow.Query", "Game", data);
  ...
  GameAll(request: QueryAllGameRequest): Promise<QueryAllGameResponse> {
    ...
    const promise = this.rpc.request("gchain.snow.Query", "GameAll", data);
