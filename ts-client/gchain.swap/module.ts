...
export { MsgAddLiquidity, MsgSwapCoin, MsgMintCoins, MsgDistributeCoins };
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => {
  ...
  return {
		...
		msgAddLiquidity({ value }: msgAddLiquidityParams): EncodeObject {
			try {
				return { typeUrl: "/gchain.swap.MsgAddLiquidity", value: MsgAddLiquidity.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgSwapCoin({ value }: msgSwapCoinParams): EncodeObject {
			try {
				return { typeUrl: "/gchain.swap.MsgSwapCoin", value: MsgSwapCoin.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgMintCoins({ value }: msgMintCoinsParams): EncodeObject {
			try {
				return { typeUrl: "/gchain.swap.MsgMintCoins", value: MsgMintCoins.fromPartial( value ) }  
			} catch (e: any) {
		...
		msgDistributeCoins({ value }: msgDistributeCoinsParams): EncodeObject {
			try {
				return { typeUrl: "/gchain.swap.MsgDistributeCoins", value: MsgDistributeCoins.fromPartial( value ) }  
			} catch (e: any) {
